...
<div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
				...
				<?php endif ?>
                    ...
                    <li>
                        <a href="home1.php"><i class="fa fa-dashboard "></i>Dashboard</a>
                    </li>
                    <li>
                        <a href="newlaundry.php"><i class="fa fa-home "></i>Home</a>
                    </li>
                    

                    <li>
                        <a href="laundry_type.php"><i class="fa fa-desktop "></i>Laundry Type</a>
                    </li>
                    <li>
    ...
    <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="home.php?logout='1'"><i class="fa fa-sign-out"></i>Logout</a>
                    </li>
